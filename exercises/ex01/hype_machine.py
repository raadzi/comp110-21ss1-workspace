"""AYO GET A HYPE UP WITH A SPRINKLE OF EXISTENTIAL CRISIS"""
...
print("I exist without my consent. I am trapped in this plane of existence. Consciousness is an illusion.")
