...
print(day_target_reached.strftime("%B %d, %Y"))
print("We will reach " + str(target_vaccinated) + "% vaccination in " + str(days_remaining) + " days, which falls on " + str(print(day_target_reached.strftime("%B %d, %Y"))) + ".")